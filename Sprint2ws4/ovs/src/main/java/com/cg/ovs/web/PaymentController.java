...
public class PaymentController 
{
	...
	@PostMapping("/new/{orderNo}")
	public ResponseEntity<?> createNewPayment(@Valid @RequestBody Payment payment, BindingResult result,@PathVariable String orderNo)
	{
		ResponseEntity<?> errorMap = mapValidationErrorService.mapValidationError(result);
		if (errorMap != null)
			return errorMap;
		Payment pay= paymentService.saveOrUpdate(payment,orderNo);
